...
describe WatchersController do
  ...
  let(:valid_attributes) { { "params" => "MyText" } }
  ...
  describe "GET show" do
    it "assigns the requested watcher as @watcher" do
      watcher = Watcher.create! valid_attributes
      get :show, {:id => watcher.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested watcher as @watcher" do
      watcher = Watcher.create! valid_attributes
      get :edit, {:id => watcher.to_param}, valid_session
      assigns(:watcher).should eq(watcher)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved watcher as @watcher" do
        ...
        post :create, {:watcher => { "params" => "invalid value" }}, valid_session
        assigns(:watcher).should be_a_new(Watcher)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested watcher" do
        ...
        Watcher.any_instance.should_receive(:update_attributes).with({ "params" => "MyText" })
        put :update, {:id => watcher.to_param, :watcher => { "params" => "MyText" }}, valid_session
      end

      it "assigns the requested watcher as @watcher" do
        watcher = Watcher.create! valid_attributes
        put :update, {:id => watcher.to_param, :watcher => valid_attributes}, valid_session
        assigns(:watcher).should eq(watcher)
      end
    ...
    describe "with invalid params" do
      it "assigns the watcher as @watcher" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Watcher.any_instance.stub(:save).and_return(false)
        put :update, {:id => watcher.to_param, :watcher => { "params" => "invalid value" }}, valid_session
        assigns(:watcher).should eq(watcher)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested watcher" do
      watcher = Watcher.create! valid_attributes
      expect {
        delete :destroy, {:id => watcher.to_param}, valid_session
      }.to change(Watcher, :count).by(-1)
    end
